...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle) {
    //Set sub title
    setText(env, title, OBFUSCATE("<b>Modded by Sun</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                     "<p style=\"color:green;\">Modded by Sun</p> | "
                                     "</p>"
                                     "</marquee></b>"));
    ...
    Dialog(env,
           ctx,
           OBFUSCATE("hi diddler"),
           OBFUSCATE("first time modding lol"),
           OBFUSCATE("nullptr"), // set nullptr if btn-link is not needed
           OBFUSCATE("Close"),
           3, // set 0 if auto-close is not needed
           OBFUSCATE("nullptr")); // set nullptr if btn-link is not needed

    //Toast Example
    Toast(env, ctx, OBFUSCATE("Modded by Sun"), ToastLength::LENGTH_LONG);
}
...
jobjectArray GetFeatureList(JNIEnv *env, jobject context) {
    jobjectArray ret;
    const char *features[] = {
            OBFUSCATE("Category_Combat Features"),
            OBFUSCATE("1_Toggle_Silent Aim"),
            OBFUSCATE("2_Toggle_No Death"),
            OBFUSCATE("Category_Visuals"),
            OBFUSCATE("3_Toggle_ESP Box"),
            OBFUSCATE("4_Toggle_ESP Line"),
            OBFUSCATE("Category_Economy"),
            OBFUSCATE("5_SeekBar_Score Multiplier_1_100"),
            OBFUSCATE("6_SeekBar_Coins Multiplier_1_100"),
    };
